...
class API{
  ...
  static public function runSingleton(){
    ...
    if(self::$_instance->authentize() && self::$_instance->authorize()){
      self::$_instance->initController();
      self::$_instance->initAction();
    }else{
      self::$_instance->output = array("code"=>"404","status"=>"NOT FOUND","message"=> "The requested resource is invalid","data"=>"");
    }

    self::$_instance->sendResponse();
